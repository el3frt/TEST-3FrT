<header>
      <nav class="navbar navbar-expand-md shadow-sm navbar-dark align-middle" style="background-image: url('https://miro.medium.com/max/1100/1*HTC1oMKYwC7a8vUBsiplhw.gif')">        
        <div class="container px-3">
            <a class="navbar-brand" href="<?= site_url() ?>"><i class="bi bi-laptop px-2"></i><?= BASE_NAME ?></a>
                                    ...
                                    <?php if ($user->level == 1) : ?>
                                        ...
                                        <li>
                                         ...
                                         <a class="dropdown-item" href="<?= site_url('upload') ?>">
                                            <i class="bi bi-gear"></i> Lib Online
                                        </a>
                                    </li>
                                    <li>
                                            <hr class="dropdown-divider">
