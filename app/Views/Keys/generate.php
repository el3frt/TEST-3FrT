    ...
    <div class="col-lg-12">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-header p3"style="background-image: url('https://i.postimg.cc/3rLBGs9m/images-3.jpg')" text-white">
                        ...
                        <a class="btn btn-outline-dark btn-sm" href="<?= site_url('keys/download/new') ?>"><i class="bi bi-person-plus"></i>Download New Keys </a>
...
<div class="row justify-content-center">
    <div class="col-lg-6">
        ...
        <?php if (session()->getFlashdata('user_key')) : ?>
            ...
            License : <strong class=""><?= session()->getFlashdata('user_key') ?>      <i class="bi bi-clipboard" name="copy" id="copybtn" onclick="copyText()"></i></strong>
            <br>
